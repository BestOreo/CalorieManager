...
public class StepCountPersistenceHelper {
     ...
     */
    public static final String BROADCAST_ACTION_STEPS_SAVED = "com.example.nuc.caloriemanager.STEPS_SAVED";
    public static final String BROADCAST_ACTION_STEPS_UPDATED = "com.example.nuc.caloriemanager.STEPS_UPDATED";
    public static final String BROADCAST_ACTION_STEPS_INSERTED = "com.example.nuc.caloriemanager.STEPS_INSERTED";

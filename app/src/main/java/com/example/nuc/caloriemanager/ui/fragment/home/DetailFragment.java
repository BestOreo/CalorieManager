...
public class DetailFragment extends BaseBackFragment {
    ...
    public static DetailFragment newInstance(String title, int position) {
    ...
    private void initView(View view) {
        ...
        mTvContentTitle = (TextView) view.findViewById(R.id.tv_title);
        mTvImage = (ImageView)view.findViewById(R.id.tv_image) ;
        mToolbar.setTitle("今日热读");
    ...
    private void initDelayView() {
        ...
        String[] mContents = getResources().getStringArray(R.array.large_text);
        String[] mContents_title = getResources().getStringArray(R.array.array_title);


        mTvContent.setText(mContents[mPosition]);
        mTvContentTitle.setText(mContents_title[mPosition]);
        mTvImage.setImageResource(R.drawable.image_dir);
        mTvImage.setImageLevel(mPosition);

        //mTvContent.setText(R.string.);
